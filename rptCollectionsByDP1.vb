...
Public Class rptCollectionsByDP1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCollectionsByDP1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptCollectionsByDP1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCollectionsByDP1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCollectionsByDP1 = New rptCollectionsByDP1()
        rpt.Site = Me.Site
        Return rpt
    End Function
