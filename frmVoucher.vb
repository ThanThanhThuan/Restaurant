...
Public Class frmVoucher
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Next
            con.Close()
            LedgerSave(dtpDate.Value.Date, "Expense A/c", txtVoucherNo.Text, "Voucher", Val(txtGrandTotal.Text), 0, txtVoucherNo.Text, "Cash")
            LedgerSave(dtpDate.Value.Date, "Cash", txtVoucherNo.Text, "Voucher", 0, Val(txtGrandTotal.Text), "", "Expenses")
    ...
    Public Sub DeleteRecord()
        Try
            ...
            If RowsAffected > 0 Then
                LedgerDelete(txtVoucherNo.Text, "Voucher")
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            Next
            con.Close()
            LedgerUpdate1(dtpDate.Value.Date, "Expense Account", Val(txtGrandTotal.Text), 0, txtVoucherNo.Text, txtVoucherNo.Text, "Voucher")
            LedgerUpdate1(dtpDate.Value.Date, "Cash", 0, Val(txtGrandTotal.Text), "", txtVoucherNo.Text, "Voucher")
