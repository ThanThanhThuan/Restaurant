        ...
        Try
            ...
            If dgw.Rows.Count > 0 Then
                If lblSet.Text = "Employee" Then
                    ...
                    lblSet.Text = ""
                End If
                If lblSet.Text = "Collections Report" Then
                    Dim dr As DataGridViewRow = dgw.SelectedRows(0)
                    Me.Hide()
                    frmDeliveryPersonLedger.Show()
                    frmDeliveryPersonLedger.txtDPID.Text = dr.Cells(1).Value.ToString()
                    frmDeliveryPersonLedger.txtDPName.Text = dr.Cells(2).Value.ToString()
                    lblSet.Text = ""
                End If
            End If
        Catch ex As Exception
