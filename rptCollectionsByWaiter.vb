...
Public Class rptCollectionsByWaiter
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCollectionsByWaiter.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptCollectionsByWaiter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCollectionsByWaiter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCollectionsByWaiter = New rptCollectionsByWaiter()
        rpt.Site = Me.Site
        Return rpt
    End Function
