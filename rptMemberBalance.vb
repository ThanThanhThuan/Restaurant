...
Public Class rptMemberBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptMemberBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMemberBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMemberBalance = New rptMemberBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
