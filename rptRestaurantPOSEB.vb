...
Public Class rptRestaurantPOSEB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptRestaurantPOSEB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRestaurantPOSEB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRestaurantPOSEB = New rptRestaurantPOSEB()
        rpt.Site = Me.Site
        Return rpt
    End Function
