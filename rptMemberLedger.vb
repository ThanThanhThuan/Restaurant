...
Public Class rptMemberLedger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptMemberLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMemberLedger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMemberLedger = New rptMemberLedger()
        rpt.Site = Me.Site
        Return rpt
    End Function
