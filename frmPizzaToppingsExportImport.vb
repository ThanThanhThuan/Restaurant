...
Public Class frmPizzaToppingsExportImport
    Private Sub auto()
        Try
    ...
    Public Sub Getdata()
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(ToppingName), RTRIM(PizzaSize),Rate from PizzaTopping order by ToppingName", con)
            ...
            For Each row As DataGridViewRow In DataGridView1.Rows
                If Not row.IsNewRow Then
                    ...
                    If Not rdr.Read() Then
                        ...
                        con = New SqlConnection(cs)
                        con.Open()
                        Dim cb As String = "Insert Into PizzaTopping(T_ID,ToppingName,PizzaSize,Rate,BackColor) Values(@d3,@d1,@d2," & Val(row.Cells(2).Value) & ",-12439982)"
