...
Public Module ModFunc
    ...
    End Function
    Sub RefreshRecord2()
        Dim obj As frmMenuItem = DirectCast(Application.OpenForms("frmDish"), frmMenuItem)
        obj.fillCombo()
    End Sub
    Sub RefreshRecord3()
        Dim obj As frmPOS = DirectCast(Application.OpenForms("frmRestaurantPOS"), frmPOS)
        obj.fillTableNo()
    End Sub
    ...
    Sub SupplierLedgerUpdate(ByVal a As DateTime, ByVal b As String, ByVal e As Decimal, ByVal f As Decimal, ByVal g As String, ByVal h As String)
        ...
        con.Close()
    End Sub
    Sub LedgerSave(ByVal a As DateTime, ByVal b As String, ByVal c As String, ByVal d As String, ByVal e As Decimal, ByVal f As Decimal, ByVal g As String, ByVal h As String, Optional section As String = "")
        con = New SqlConnection(cs)
        con.Open()
        Dim cb As String = "insert into LedgerBook(Date, Name, LedgerNo, Label,Debit,Credit,PartyID,AccLedger,section) Values (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8,@d9)"
        cmd = New SqlCommand(cb)
        cmd.Parameters.AddWithValue("@d1", a)
        cmd.Parameters.AddWithValue("@d2", b)
        cmd.Parameters.AddWithValue("@d3", c)
        ...
        cmd.Parameters.AddWithValue("@d9", section)
        cmd.Connection = con
        cmd.ExecuteReader()
        con.Close()
    End Sub
    ...
    Sub MemberLedgerUpdate(ByVal a As DateTime, ByVal b As Integer, ByVal e As Decimal, ByVal f As Decimal, ByVal g As Integer, ByVal h As String, ByVal i As String)
        ...
        con.Close()
    End Sub
    Sub CreditCustomerLedgerSave(ByVal a As DateTime, ByVal c As String, ByVal d As String, ByVal e As Decimal, ByVal f As Decimal, ByVal g As Integer)
        con = New SqlConnection(cs)
        con.Open()
        Dim cb As String = "insert into CreditCustomerLedger(Date, LedgerNo, Label,Debit,Credit,CreditCustomer_ID) Values (@d1,@d3,@d4,@d5,@d6,@d7)"
        cmd = New SqlCommand(cb)
        cmd.Parameters.AddWithValue("@d1", a)
        cmd.Parameters.AddWithValue("@d3", c)
        cmd.Parameters.AddWithValue("@d4", d)
        ...
        con.Close()
    End Sub
    Sub CreditCustomerLedgerDelete(ByVal a As String, ByVal b As String)
        con = New SqlConnection(cs)
        con.Open()
        Dim cq As String = "delete from CreditCustomerLedger where LedgerNo=@d1 and Label=@d2"
        cmd = New SqlCommand(cq)
        cmd.Parameters.AddWithValue("@d1", a)
        cmd.Parameters.AddWithValue("@d2", b)
        cmd.Connection = con
        ...
        con.Close()
    End Sub
    Sub CreditCustomerLedgerUpdate(ByVal a As DateTime, ByVal e As Decimal, ByVal f As Decimal, ByVal g As Integer, ByVal h As String, ByVal i As String)
        con = New SqlConnection(cs)
        con.Open()
        Dim cb As String = "Update CreditCustomerLedger set Date=@d1,Debit=@d3,Credit=@d4,CreditCustomer_ID=@d5 where LedgerNo=@d6 and Label=@d7"
        cmd = New SqlCommand(cb)
        cmd.Parameters.AddWithValue("@d1", a)
        cmd.Parameters.AddWithValue("@d3", e)
        cmd.Parameters.AddWithValue("@d4", f)
        ...
        con.Close()
    End Sub
    Sub ODN(ByVal a As String, ByVal b As String)
        con = New SqlConnection(cs)
        con.Open()
        Dim cb As String = "Insert into tblOrder(ODNo,BillNo) values(@d1,@d2)"
        cmd = New SqlCommand(cb)
        cmd.Parameters.AddWithValue("@d1", a)
        cmd.Parameters.AddWithValue("@d2", b)
        cmd.Connection = con
        ...
        con.Close()
    End Sub
    Sub RawMaterialUsed(ByVal st1 As Integer, ByVal st2 As String)
        con = New SqlConnection(cs)
        con.Open()
        Dim cb As String = "insert into RM_Used(RM_ID,BillDate,BillNo) VALUES (@d1,@d2,@d3)"
        cmd = New SqlCommand(cb)
        cmd.Connection = con
        cmd.Parameters.AddWithValue("@d1", st1)
        cmd.Parameters.AddWithValue("@d2", System.DateTime.Now)
        ...
        con.Close()
    End Sub
    Sub RawMaterialUsedDel(ByVal st1 As String)
        con = New SqlConnection(cs)
        con.Open()
        Dim cb As String = "Delete from RM_Used where BillNo=@d1"
        cmd = New SqlCommand(cb)
        cmd.Connection = con
        cmd.Parameters.AddWithValue("@d1", st1)
        cmd.ExecuteReader()
