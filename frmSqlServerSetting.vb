...
Public Class frmSqlServerSetting
                ...
                If (con.State = ConnectionState.Open) Then
                    If MsgBox("It will create the DB and configure the sql server, Do you want to proceed?", MsgBoxStyle.YesNo + MsgBoxStyle.Information) = MsgBoxResult.Yes Then
                        ...
                        Using sw As StreamWriter = New StreamWriter(Application.StartupPath & "\SQLSettings.dat")
                            If cmbAuthentication.SelectedIndex = 0 Then
                                sw.WriteLine("Data Source=" & cmbServerName.Text.Trim & ";Initial Catalog=RPOS_DB;Integrated Security=True;MultipleActiveResultSets=True")
                                sw.Close()
                            End If
                            If cmbAuthentication.SelectedIndex = 1 Then
                                sw.WriteLine("Data Source=" & cmbServerName.Text.Trim & ";Initial Catalog=RPOS_DB;User ID=" & txtUserName.Text.Trim & ";Password=" & txtPassword.Text & ";MultipleActiveResultSets=True")
                                sw.Close()
                            End If
                            CreateDB()
    ...
    Sub CreateDB()
        Try
            con = New SqlConnection("Data source=" & cmbServerName.Text & ";Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=True")
            con.Open()
            Dim cb2 As String = "Select * from sysdatabases where name='RPOS_DB'"
            ...
            If rdr.Read() Then
                con = New SqlConnection("Data source=" & cmbServerName.Text & ";Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=True")
                con.Open()
                Dim cb1 As String = "USE Master ALTER DATABASE RPOS_DB SET Single_User WITH Rollback Immediate DROP database RPOS_DB"
                ...
                con = New SqlConnection("Data source=" & cmbServerName.Text & ";Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=True")
                con.Open()
                Dim cb As String = "Create Database RPOS_DB"
            ...
            Else
                con = New SqlConnection("Data source=" & cmbServerName.Text & ";Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=True")
                con.Open()
                Dim cb3 As String = "Create Database RPOS_DB"
        ...
        End Try
    End Sub
    Private Sub LinkLabel1_LinkClicked(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lblSearchServers.LinkClicked
        Try
            Cursor = Cursors.WaitCursor
            Timer3.Enabled = True
    ...
    Private Sub cmbInstallationType_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cmbInstallationType.SelectedIndexChanged
        If cmbInstallationType.SelectedIndex = 1 Then
            ...
            lblSearchServers.Visible = False
        ...
        If cmbInstallationType.SelectedIndex = 0 Then
            ...
            lblSearchServers.Visible = True
            btnBlankDB.Visible = True
            btnDemoDB.Text = "Create Demo DB " & vbCrLf & "and Proceed"
