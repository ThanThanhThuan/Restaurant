...
Public Class rptCollectionsByDP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptCollectionsByDP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCollectionsByDP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCollectionsByDP = New rptCollectionsByDP()
        rpt.Site = Me.Site
        Return rpt
    End Function
