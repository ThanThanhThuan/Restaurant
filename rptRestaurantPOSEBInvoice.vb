...
Public Class rptRestaurantPOSEBInvoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRestaurantPOSEBInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptRestaurantPOSEBInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRestaurantPOSEBInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRestaurantPOSEBInvoice = New rptRestaurantPOSEBInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
