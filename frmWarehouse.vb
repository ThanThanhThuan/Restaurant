...
Public Class frmWarehouse
    ...
    Private Sub DeleteRecord()
        ...
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cl3 As String = "select WarehouseName from StockAdjustment_Warehouse,Warehouse where StockAdjustment_Warehouse.Warehouse=Warehouse.WarehouseName and WarehouseName=@d1"
            cmd = New SqlCommand(cl3)
            cmd.Connection = con
            cmd.Parameters.AddWithValue("@d1", txtWarehouseName.Text)
            rdr = cmd.ExecuteReader()
            If rdr.Read Then
                MessageBox.Show("Unable to delete..Already in use in Stock Adjustment", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btnWarehouseType_Click(sender As Object, e As EventArgs) Handles btnWarehouseType.Click
