    ...
    Private Sub btnTopping_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            ...
            For Each row As DataGridViewRow In frmPizzaPOS.DataGridView1.Rows
                If row.Cells(0).Value = str And row.Cells(10).Value = "Topping" Then
            ...
            End If
            Compute()
            frmPizzaPOS.DataGridView1.Rows.Add(str, frmPizzaPOS.lblPizzaSize.Text, 0, 1, 0, 0, 0, HSTPer, 0, 0, "Topping")
            Dim k As Double = 0
