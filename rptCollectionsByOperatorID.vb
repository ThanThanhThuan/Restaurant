...
Public Class rptCollectionsByOperatorID
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCollectionsByOperatorID.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptCollectionsByOperatorID.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCollectionsByOperatorID
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCollectionsByOperatorID = New rptCollectionsByOperatorID()
        rpt.Site = Me.Site
        Return rpt
    End Function
