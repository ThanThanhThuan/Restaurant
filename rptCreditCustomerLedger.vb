...
Public Class rptCreditCustomerLedger
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCreditCustomerLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptCreditCustomerLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCreditCustomerLedger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCreditCustomerLedger = New rptCreditCustomerLedger()
        rpt.Site = Me.Site
        Return rpt
    End Function
