...
Public Class rptRPOSByMonth
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptRPOSByMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRPOSByMonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRPOSByMonth = New rptRPOSByMonth()
        rpt.Site = Me.Site
        Return rpt
    End Function
