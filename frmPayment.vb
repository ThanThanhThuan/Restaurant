...
Public Class frmPayment
    ...
    Private Sub DeleteRecord()
        Try
            ...
            If RowsAffected > 0 Then
                LedgerDelete(txtTransactionNo.Text, "Payment")
    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            con.Close()
            LedgerSave(dtpTranactionDate.Value.Date, "Cash", txtTransactionNo.Text, "Payment", 0, Val(txtTransactionAmount.Text), "", txtSupplierName.Text)
            LedgerSave(dtpTranactionDate.Value.Date, txtSupplierName.Text, txtTransactionNo.Text, "Payment", Val(txtTransactionAmount.Text), 0, txtSupplierID.Text, "Cash")
    ...
    Private Sub btnUpdate_Click(sender As System.Object, e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            con.Close()
            LedgerUpdate1(dtpTranactionDate.Value.Date, "Cash", 0, Val(txtTransactionAmount.Text), "", txtTransactionNo.Text, "Payment")
            LedgerUpdate1(dtpTranactionDate.Value.Date, txtSupplierName.Text, Val(txtTransactionAmount.Text), 0, txtSupplierID.Text, txtTransactionNo.Text, "Payment")
