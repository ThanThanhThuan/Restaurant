...
Public Class frmRecoveryPIN
            ...
            Timer1.Enabled = True
                If CheckForInternetConnection() = True Then
                    ...
                    If ds.Tables(0).Rows.Count > 0 Then
                        ...
                        rdr = cmd.ExecuteReader()
                        If rdr.Read() Then
                            SendMail(rdr.GetValue(0), txtEmailID.Text, "Your PIN: " & Decrypt(Convert.ToString(ds.Tables(0).Rows(0)("Password"))) & "", "Password", rdr.GetValue(2), rdr.GetValue(3), rdr.GetValue(0), Decrypt(rdr.GetValue(1)))
                            If (rdr IsNot Nothing) Then
                                rdr.Close()
                            End If
                        End If
                    End If
                    MessageBox.Show("PIN Successfully sent " & vbCrLf & "Please check your mail", "Thank you", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Me.Hide()
                    frmLogin.Show()
    ...
    Private Sub OldPassword_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs)
        If (e.KeyChar < Chr(48) Or e.KeyChar > Chr(57)) And e.KeyChar <> Chr(8) Then
            e.Handled = True
        End If
    End Sub

    Private Sub NewPassword_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs)
        If (e.KeyChar < Chr(48) Or e.KeyChar > Chr(57)) And e.KeyChar <> Chr(8) Then
            e.Handled = True
        End If
    End Sub

    Private Sub ConfirmPassword_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs)
        If (e.KeyChar < Chr(48) Or e.KeyChar > Chr(57)) And e.KeyChar <> Chr(8) Then
            e.Handled = True
        End If
    End Sub
