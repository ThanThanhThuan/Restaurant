...
Public Class rptWorkPeriod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptWorkPeriod.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWorkPeriod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWorkPeriod = New rptWorkPeriod()
        rpt.Site = Me.Site
        Return rpt
    End Function
