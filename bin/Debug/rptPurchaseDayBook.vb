...
Public Class rptPurchaseDayBook
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptPurchaseDayBook.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseDayBook
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseDayBook = New rptPurchaseDayBook()
        rpt.Site = Me.Site
        Return rpt
    End Function
