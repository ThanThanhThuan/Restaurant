...
Public Class rptStockTransferInvoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockTransferInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptStockTransferInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockTransferInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockTransferInvoice = New rptStockTransferInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
