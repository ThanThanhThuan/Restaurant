...
Public Class rptRestaurantPOSKOTInvoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRestaurantPOSKOTInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptRestaurantPOSKOTInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRestaurantPOSKOTInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRestaurantPOSKOTInvoice = New rptRestaurantPOSKOTInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
