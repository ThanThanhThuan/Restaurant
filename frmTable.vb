...
Public Class frmTable
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            con = New SqlConnection(cs)
            con.Open()
            Dim cb1 As String = "update RestaurantPOS_OrderedProductKOT set T_Number=@d3 where T_Number=@d2"
    ...
    Private Sub btnDeactivate_Click(sender As System.Object, e As System.EventArgs) Handles btnActivate_Deactivate.Click
        ...
        Try
            ...
            If btnActivate_Deactivate.Text = "Deactivate" Then
                con = New SqlConnection(cs)
                con.Open()
                Dim cl3 As String = "select R_Table.TableNo from RestaurantPOS_OrderInfoKOT,R_Table where RestaurantPOS_OrderInfoKOT.TableNo=R_Table.TableNo and R_Table.TableNo=@d1 and KOT_Status in ('Open','Served','Prepared')"
    ...
    Private Sub btnExportExcel_Click(sender As System.Object, e As System.EventArgs) Handles btnExportExcel.Click
        frmTablesExportImport.Reset()
        frmTablesExportImport.ShowDialog()
    End Sub
End Class
