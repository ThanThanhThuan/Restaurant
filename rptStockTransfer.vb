...
Public Class rptStockTransfer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptStockTransfer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockTransfer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockTransfer = New rptStockTransfer()
        rpt.Site = Me.Site
        Return rpt
    End Function
