...
Public Class rptCreditCustomerLedger1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCreditCustomerLedger1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptCreditCustomerLedger1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCreditCustomerLedger1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCreditCustomerLedger1 = New rptCreditCustomerLedger1()
        rpt.Site = Me.Site
        Return rpt
    End Function
