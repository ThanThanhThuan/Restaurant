...
Public Class rptRestaurantPOSHDInvoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRestaurantPOSHDInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptRestaurantPOSHDInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRestaurantPOSHDInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRestaurantPOSHDInvoice = New rptRestaurantPOSHDInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
