...
Public Class rptRestaurantPOSTA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RestaurantPOS6.rptRestaurantPOSTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRestaurantPOSTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRestaurantPOSTA = New rptRestaurantPOSTA()
        rpt.Site = Me.Site
        Return rpt
    End Function
